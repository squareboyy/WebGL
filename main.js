...
function draw() { 
    ...
    // Diffuse (основне розсіювання - біле)
    gl.uniform3fv(shProgram.iDiffuseProduct,  [0.8, 0.8, 0.8]);
    // Specular (блік - білий)
...
function initGL() {
    ...
    lightModel.BufferData(sphereData.vertices, sphereData.normals, sphereData.indices, null);
...
function regenerateSurface() {
    ...
    surface.BufferData(data.verticesF32, data.normalsF32, data.indicesTriU16, data.indicesLinesU16);
}
